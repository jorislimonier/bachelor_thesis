...
In this section, we assume that there exists some ``true value" that would make the parameter \(\bta\) fit the observations to the predictions perfectly. We call this ideal parameter vector \(\bta^0\).
