...
\begin{proof}
    ...
    Now, since $V_j$ is $\mathscr{N} (0,1)$-distributed and $\sqrt{t^{2}+2 \log p} > 0$.

    \begin{align*}
        P(Z > x) & = \frac{1}{\sqrt{2\pi}} \int_x^{\infty} exp(-y^2/2) dy       \\
               & < \frac{1}{x \sqrt{2\pi}} \int_x^{\infty} y * e^{-y^2 / 2} dy \\
