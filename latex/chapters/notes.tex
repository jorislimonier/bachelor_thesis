...
\begin{lemma}[Lemma 6.3.]
    ...
    $$
        2\left\|\mathbf{X}\left(\hat{\beta}-\beta^{0}\right)\right\|_{2}^{2} / n+\lambda\left\|\hat{\beta}_{S_{0}^{c}}\right\|_{1} \leq 3 \lambda\left\|\hat{\beta}_{S_{0}}-\beta_{S_{0}}^{0}\right\|_{1}
    $$
\end{lemma}
\begin{proof}
