...
\end{equation}
Now, we can verify that our estimator has some fundamental properties. Namely, we want to make sure that it is unbiased, \ie $\E [\btahat] = \bta$.
\begin{align*}
    \E \left[ \btahat \right]
...
\]
Therefore the variance of \(\btahat\) is given by
\begin{align*}
    \var(\btahat)
